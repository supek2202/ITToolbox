...
class DeviceInspectorApp:
    ...
    def init_ui(self):
        ...
        # 底部版本号
        version_label = tk.Label(self.root, text="NetInspector v1.0 | 网络设备巡检工具",
...
"""
    ...
    def show_about(self):
        ...
        about_dialog.title("关于 NetInspector")
        ...
        # 标题
        title_label = tk.Label(main_frame, text="NetInspector", font=("Helvetica", 20, "bold"), fg="#1976D2")
