...
NetInspector 是一个网络设备巡检工具，支持多厂商设备（华为、H3C、Cisco、锐捷、Juniper、浪潮等）的自动化巡检。
...
```
network_inspector/
├── net_inspector.py      # 主程序（79KB）
├── commands.json         # 巡检命令库（40KB，106条命令）
├── NetInspector.spec     # PyInstaller 配置
...
**地址：** https://github.com/supek2202/NetInspector
...
# 3. 打包应用
pyinstaller NetInspector.spec

# 4. 运行
open dist/NetInspector.app
```

### 输出位置
- 应用包：`dist/NetInspector.app`
- 构建缓存：`build/`
...
1. 打开 https://github.com/supek2202/NetInspector/actions
2. 点击最新的成功构建
3. 在 **Artifacts** 区域下载 `NetInspector-Windows.zip`
4. 解压后运行 `NetInspector.exe`
...
1. 打开 https://github.com/supek2202/NetInspector/edit/main/.github/workflows/build.yml
  ...
  build:
    ...
    steps:
      ...
      - name: Upload artifact
        ...
        with:
          name: NetInspector-Windows
          path: dist/NetInspector/
          retention-days: 30
```
...
如有问题，请通过以下方式反馈：
- GitHub Issues：https://github.com/supek2202/NetInspector/issues
- 项目文档：见 SPEC.md

---

*本文档由 OpenClaw AI 自动生成，记录了 NetInspector 项目的部署和开发历程。*
